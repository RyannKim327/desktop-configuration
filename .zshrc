...
# Change command color (default: green)
ZSH_HIGHLIGHT_STYLES[command]='fg=cyan,bold'

# Change unknown command color (default: red)
ZSH_HIGHLIGHT_STYLES[unknown-command]='fg=red,bold'

# Change quoted arguments color (default: blue)
ZSH_HIGHLIGHT_STYLES[single-quoted-argument]='fg=yellow'
ZSH_HIGHLIGHT_STYLES[double-quoted-argument]='fg=yellow,bold'


PS1='
%F{cyan}───────────────────── %F{white}୨୧ %F{cyan}─────────────────────%F{white}
╭─%F{green}[𝒌.𝒈𝒖𝒊𝒏: %~ ]%F{white} 
│ %F{blue}𓃻 𓃻 𓃻%F{white}
╰──➢ '
